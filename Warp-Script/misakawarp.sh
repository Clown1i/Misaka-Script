...
install_wgcf(){
    ...
    if [[ $SYSTEM == "CentOS" ]]; then
        ...
        if [[ $main -lt 5 ]] || [[ $minor -lt 6 ]]; then
            if [[ $vpsvirt =~ "kvm"|"xen"|"microsoft"|"vmware"|"qemu" ]]; then
                wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wireguard-go-$(archAffix) -O /usr/bin/wireguard-go
                chmod +x /usr/bin/wireguard-go
            fi
        fi
        if [[ $vsid == 9 ]] && [[ -z $(type -P resolvconf) ]]; then
            wget -N https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/resolvconf -O /usr/sbin/resolvconf
    ...
    wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wgcf-latest-linux-$(archAffix) -O /usr/local/bin/wgcf
...
install_wireproxy(){
    ...
    wget -N https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wireproxy-$(archAffix) -O /usr/local/bin/wireproxy
...
warpnf(){
    ...
    case "$clientInput" in
        1 ) wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/wgcf-warp/netfilx4.sh && bash netfilx4.sh ;;
        2 ) wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/wgcf-warp/netfilx6.sh && bash netfilx6.sh ;;
        3 ) wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/warp-cli/netfilxcli.sh && bash netfilxcli.sh ;;
        4 ) wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/wireproxy-warp/netfilx-wireproxy.sh && bash netfilx-wireproxy.sh ;;
    esac
}
...
info_bar(){
    ...
    echo -e "# ${GREEN}GitLab${PLAIN}: https://raw.githubusercontent.com/Clown1i/Misaka-Script                    #"
