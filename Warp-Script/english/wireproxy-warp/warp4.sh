...
install_wgcf(){
    wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wgcf_latest_linux_$(archAffix) -O /usr/local/bin/wgcf
...
download_wireproxy(){
    if [[ $arch == "amd64" || $arch == "x86_64" ]]; then
        wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wireproxy-amd64 -O /usr/local/bin/wireproxy
        chmod +x /usr/local/bin/wireproxy
    fi
    if [[ $arch == "armv8" || $arch == "arm64" || $arch == "aarch64" ]]; then
        wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wireproxy-arm64 -O /usr/local/bin/wireproxy
        chmod +x /usr/local/bin/wireproxy
    fi
    if [[ $arch == "s390x" ]]; then
        wget -N --no-check-certificate https://raw.githubusercontent.com/Clown1i/Misaka-Script/main/Warp-Script/files/wireproxy-s390x -O /usr/local/bin/wireproxy
        chmod +x /usr/local/bin/wireproxy
    fi
}
